 ...
 */
 var getJsPath=function(){
	 //return "http://netbar.sdocdn.com:8080/html/common/My97DatePicker/";
	for(var i=0,scripts=document.getElementsByTagName("script"),len=scripts.length;i<len;i++){

		if(/WdatePicker.js(\?.+)?$/i.test(scripts[i].src)){
			return scripts[i].src.replace(/WdatePicker.js(\?.+)?$/i,"")
		}
	}
	throw new Error("WdatePicker.js can't be found!");
}

var css='<link rel="stylesheet" type="text/css" href="'+getJsPath()+'/skin/whyGreen/datepicker.css" />'
var sLL="var langList = [{name:'zh-cn',	charset:'UTF-8'}];"

var skin="var skinList = [{name:'default',	charset:'UTF-8'},{name:'whyGreen',	charset:'UTF-8'}];"


var sVar='var $d, $dp, $pdp = parent.$dp, $dt, $tdt, $sdt, $IE=$pdp.ie, $FF = $pdp.ff,$OPERA=$pdp.opera, $ny, $cMark = false;if ($pdp.eCont) {$dp = {};for (var p in $pdp) {$dp[p] = $pdp[p];}}else{$dp = $pdp;}';


var sLang=';var $lang={errAlertMsg: "\u4E0D\u5408\u6CD5\u7684\u65E5\u671F\u683C\u5F0F\u6216\u8005\u65E5\u671F\u8D85\u51FA\u9650\u5B9A\u8303\u56F4,\u9700\u8981\u64A4\u9500\u5417?",aWeekStr: ["\u5468","\u65E5","\u4E00","\u4E8C","\u4E09","\u56DB","\u4E94","\u516D"],aLongWeekStr:["\u5468","\u661F\u671F\u65E5","\u661F\u671F\u4E00","\u661F\u671F\u4E8C","\u661F\u671F\u4E09","\u661F\u671F\u56DB","\u661F\u671F\u4E94","\u661F\u671F\u516D"],aMonStr: ["\u4E00\u6708","\u4E8C\u6708","\u4E09\u6708","\u56DB\u6708","\u4E94\u6708","\u516D\u6708","\u4E03\u6708","\u516B\u6708","\u4E5D\u6708","\u5341\u6708","\u5341\u4E00","\u5341\u4E8C"],aLongMonStr: ["\u4E00\u6708","\u4E8C\u6708","\u4E09\u6708","\u56DB\u6708","\u4E94\u6708","\u516D\u6708","\u4E03\u6708","\u516B\u6708","\u4E5D\u6708","\u5341\u6708","\u5341\u4E00\u6708","\u5341\u4E8C\u6708"],clearStr: "\u6E05\u7A7A",todayStr: "\u4ECA\u5929",okStr: "\u786E\u5B9A",updateStr: "\u786E\u5B9A",timeStr: "\u65F6\u95F4",quickStr: "\u5FEB\u901F\u9009\u62E9", err_1: "\u6700\u5C0F\u65E5\u671F\u4E0D\u80FD\u5927\u4E8E\u6700\u5927\u65E5\u671F!"};'



var sCalendar='<script src=\"'+getJsPath()+'calendar.js\"></script>'

var strhtml='<head><meta http-equiv="content-type" content="text/xml; charset=utf-8" /><title>My97DatePicker</title>'+css+'\<script\>'+sLL+skin+sVar+sLang+'\</script\></head><body style="margin:0;padding:0;" tabindex=0></body>'+sCalendar;
...
specialDates: null,
    ...
    function U(J, C) {//alert("U 379");
        ...
        } else if (J.eCont) {//alert("if 401");
            J.eCont = $dp.$(J.eCont);
            $dp.flatCfgs.push(J);
            if ($dp.status == 2) H()
        } else {//alert("if 405 "+$dp.status);
            if ($dp.status == 0) {
                U(null, true);
                return
            }
    ...
    function K(H, $) {
        ...
        if (!$dp.dd || $dp.eCont || ($dp.lang && $dp.realLang && $dp.realLang.name != $dp.lang && $dp.getLangIndex && $dp.getLangIndex($dp.lang) >= 0)) {
            ...
            if (_.$dpPath == "") F(A);
//debugger;
           // var B ='<div id="calendar"></div>';// "<iframe style=\"width:1px;height:1px\" src=\""+_.$dpPath+"My97DatePicker.htm\"  frameborder=\"0\" border=\"0\" scrolling=\"no\"></iframe>";
            
			var B=iframe=document.createElement("iframe");
			...
			if ($dp.eCont) {
			   ...
			   $dp.eCont.appendChild(B);//alert("$dp.eCont.childNodes[0]="+$dp.eCont.childNodes[0].tagName +"  488");
			   ...
			   $dp.dd.appendChild(B);
                ...
                Z($dp.dd.childNodes[0], Y);//alert("$dp.dd.childNodes[0]"+$dp.dd.childNodes[0].tagName+" 498");
			...
			var dialogDoc=iframe.contentDocument || iframe.contentWindow.document;
			dialogDoc.open();
			dialogDoc.write(strhtml);
			dialogDoc.close();
        } else if ($dp.cal) {
            $dp.show();
            $dp.cal.init();
