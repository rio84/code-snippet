...
/*==================================================================
	...
	update:2010.12.8 first appendChild to frament them append to tbody
...
function Marquee(){
	...
	// 状态
	this.rollable = false;//是否能滚动。横向宽度太小或纵向高度太小或正在滚动中，此值为false。
	this.rollable_left = false;
	this.rollable_right = false;	
	this.rolling = false;
	this.loop = true;
...
function AdSlider(tabbox,contentbox,currentIndex){
	...
	_goNext=function(){var nextIndex=_currentIndex+1>=_count?0:_currentIndex+1; _showIndex(nextIndex);},
